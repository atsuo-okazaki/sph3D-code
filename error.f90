...
!************************************************************
!                                                           *
!  This routine identifies and handle the errors detected   *
...
99011    FORMAT (' maximum number of nodes overflow !',I2)
      ...
      IF (where(1:6).EQ.'naybor') THEN
         IF (iwhat.EQ.1) WRITE (iprint, 99012)
99012    FORMAT (' hash table too short !')
         IF (iwhat.EQ.2) WRITE (iprint, 99013)
...
99018    FORMAT (' dimension for neighbor list too short, iover=', I8)
      ...
      ENDIF
!
!--Error in ghost particle number
!
...
99019    FORMAT (' number of particles+ghosts exceeds dimensions!', /, &
      ...
      ENDIF
!
!--Neighbours list dimensions too small
!
...
99020    FORMAT (' number of neighbours exceeds dimensions')
      ...
      ENDIF
!
!--Point mass neighbours list dimensions too small
!
...
99021    FORMAT (' number of point mass neighbours exceeds dimensions')
      ...
      ENDIF
!
!--Units the code was compiled with do not match binary dump file units
!
...
99022    FORMAT (' incompatible units between code and binary file')
      ...
      ENDIF
!
!--Number of gas particles less than minimum value
!
...
99027    FORMAT ('Inner Accretion radius not defined')
      ...
      ENDIF
!
!--Point masses present without telling program they exist
!
...
99030       FORMAT (' Called treef for point mass!!')
      ...
      ENDIF
!
!--Infinite loop to set h for reassigned particle in 'step'
!
...
99031    FORMAT (' Infinite loop to set h for reassigned particle')
      ...
      ENDIF
!
!--Too many new particles created
!
...
99032    FORMAT (' Total number of particles > idim')
      ...
      ENDIF
!
!--Attempt to increase synchronisation time beyond possible timestep range
!
...
99050    FORMAT (' Code compiled with insulate_GRAPE rather', &
      ...
      ENDIF
!
!--Number of point masses exceeds dimensions
!
